    ...
    <div class="content full-page">
        ...
        <div class="page-header">
            ...
            <div class="page-action">
                ...
                @if ($order->canRefund())
                    @if ($order->payment->method == 'mangopay_standard')
                        <a href="{{ route('admin.mangopay.refund.create', $order->id) }}" class="btn btn-lg btn-primary">
                            {{ __('mangopay::app.admin.system.mangopay_refund') }}
                        </a>
                    @else
