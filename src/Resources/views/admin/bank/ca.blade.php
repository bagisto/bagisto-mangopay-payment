<div class="control-group">
    <label for="bank_name">{{ __('mangopay::app.admin.bank-details.bank-name') }}</label>
...
<div class="control-group">
    <label for="institution_number">{{ __('mangopay::app.admin.bank-details.institution-number') }}</label>
...
<div class="control-group">
    <label for="branch_code">{{ __('mangopay::app.admin.bank-details.branch-code') }}</label>
