    ...
    <div class="account-content">
        ...
        <form method="post" action="{{ route('mangopay.shop.bankdetails.store') }}">
            ...
            <span class="back-icon"><a href="{{ route('customer.account.index') }}"><i class="icon icon-menu-back"></i></a></span>
                ...
                <span>
                    <button type="submit" class="btn btn-primary btn-md pull-right">Save Bank Details</button>
                </span>
            </div>
        ...
        <div>
            <div class="">          
                ...
                <div class="control-group">
                    ...
                    <input type="text" v-validate="" class="control" id="owner_name" name="owner_name"  value="{{ $data ? $data->owner_name : '' }}"
                ...
                <div class="control-group">
                    ...
                    <input type="text" v-validate="" class="control" id="owner_address" name="owner_address"  value="{{ $data ? $data->owner_address : '' }}"
                ...
                <div class="control-group">
                    ...
                    <input type="text" v-validate="" class="control" id="owner_city" name="owner_city"  value="{{ $data ? $data->owner_city : '' }}"
                ...
                <div class="control-group">
                    ...
                    <input type="text" v-validate="" class="control" id="owner_region" name="owner_region"  value="{{ $data ? $data->owner_region : '' }}"
                ...
                <div class="control-group">
                    ...
                    <input type="text" v-validate="" class="control" id="owner_postal_code" name="owner_postal_code"  value="{{ $data ? $data->owner_postal_code : '' }}"
