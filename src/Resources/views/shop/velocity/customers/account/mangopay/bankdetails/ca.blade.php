<div class="control-group">
    ...
    <input type="text" v-validate="" class="form-style" id="bank_name" name="bank_name" value="{{ $bankdetail ? $bankdetail->bank_name : '' }}"
...
<div class="control-group">
    ...
    <input type="text" v-validate="" class="form-style" id="institution_number" name="institution_number"  value="{{ $bankdetail ? $bankdetail->institution_number : '' }}"
...
<div class="control-group">
    ...
    <input type="text" v-validate="" class="form-style" id="branch_code" name="branch_code"  value="{{ $bankdetail ? $bankdetail->branch_code : '' }}"
